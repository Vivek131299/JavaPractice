...
//        }
        ...
        // Instead of above commented code, we are writing below code by using ObjectOutputStream and writeObject() for writing data.
        // Now as this class is serializable, all non-primitive fields are serializable and so just we have to call the writeObject()
