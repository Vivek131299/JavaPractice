...
public class Theatre {
    ...
    private List<Seat> seats = new ArrayList<>(); // This has been changed later from ArrayList<> to LinkedList<> , and from List to Collection.
    ...
    private class Seat implements Comparable<Seat> { // We are implementing Comparable for binary search.(See comment on line 31).
